...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegister(String username, String password, String checkPassword, String realName);
    ...
    boolean genApiKeys(Long id, String accessKey, String sercetKey);
}
